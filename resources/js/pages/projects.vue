  ...
  <section id="portofolio">
    ...
    <div class="container">
      <div class="d-flex justify-content-end mb-5">
        <button
          type="button"
          class="btn btn-primary me-2 dark-blue-color"
          @click="toggleView"
        >
          <img
            v-if="isListView"
            src="img/assets/porto/list-icon.png"
            class="py-1"
          >
          <img
            v-else
            src="img/assets/porto/list-icon-row.png"
            class="py-2"
          >
        </button>
        <button
          ...
          type="button"
          class="btn btn-primary me-2 d-flex dark-blue-color"
          data-bs-toggle="dropdown"
          aria-expanded="false"
        >
          <p class="me-4 my-auto text-white">
            Filter
          </p>
          <img
            src="img/assets/porto/filter-icon.png"
            class="my-auto"
          >
        </button>
        <ul
      ...
      <div
        v-if="isListView"
        class="row mx-auto justify-content-center mb-3"
      >
        <div
          v-for="project in currentProjects"
          :key="project.id"
          class="col-sm-4 mb-4 px-4"
        >
          <div
              ...
              <div class="row g-0">
                ...
                <div class="col-lg-10 col-7 d-flex align-items-center px-3">
                  <div class="card-body w-100 blue-font">
                    <h5 class="card-title mt-auto fs-6">
                      {{ project.name }}
                    </h5>
                    <p class="card-title mb-auto">
                      ({{ new Date(project.end_date).getFullYear() }})
                    </p>
                  </div>
                </div>
